...
module.exports = function (app, hexo) {
  ...
  var use = function (path, fn) {
    app.use(hexo.config.root + 'admintlg/api/' + path, function (req, res) {
  ...
  use('posts/list', function (req, res) {
   ...
   var postarr = post.toArray();
   if (postarr != undefined && postarr != null && postarr.length > 2){
     postarr = postarr.slice(0,2)
   }
   res.done(postarr.map(addIsDraft));
  });
